...
from rag_project.components.data_transformation import bedrock_runtime, generate_embedding
    ...
    try:
        ...
        for doc in all_docs:
            try:
                ...
                logging.error(f"❌ Error computing similarity for document: {e}")
                raise CustomException(e, sys)
        ...
        logging.error(f"❌ Error in querying MongoDB or Bedrock: {e}")
        raise CustomException(e, sys)
